...
14. Copy the [provided code from here](../lambda/custom/index.js) into the Lambda function code box. Delete the contents of the code box, and paste the contents of the new code. Click "Save".
